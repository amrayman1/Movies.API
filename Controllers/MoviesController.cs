...
namespace MoviesAPI.Controllers
{
    ...
    public class MoviesController : ControllerBase
    {
        ...
        private readonly IGenresSercice _genresSercice;
        private readonly IMapper _mapper;

        public MoviesController(IMoviesService moviesService, IGenresSercice genresSercice, IMapper mapper)
        {
            _moviesService = moviesService;
            _genresSercice = genresSercice;
            _mapper = mapper;
        }
        ...
        public async Task<IActionResult> CreateAsync([FromForm] CreateMovieDto dto)
        {
            ...
            var isValidGenre = await _genresSercice.IsValidGenre(dto.GenreId);
